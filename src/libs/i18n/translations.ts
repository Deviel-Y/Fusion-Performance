...
export const translations = {
  en: {
    ...
    hero: {
      ...
      scroll: "Scroll",
      stats: [
        { value: "12K+", label: "Transformations" },
    ...
    services: {
      ...
      headingAccent: "Weapon",
      cta: "Get This Program",
      items: [
        {
    ...
    coach: {
      badge: "The Coach",
      headingBefore: "Built in the",
      headingAccent: "Trenches.",
      headingLine2: "Proven by Results.",
      ...
      credentials: [
        ...
        "Former Competitive Bodybuilder — 3× Regional Champion",
        "12,000+ Clients Transformed Since 2017",
      ],
      name: "Coach Marcus",
    ...
    form: {
      ...
      goal: "Primary Goal",
      goalPlaceholder: "Select your primary goal",
      ...
      errorGoal: "Please select a primary goal",
    },
    goals: [
    ...
    social: {
      badge: "12k+ Transformations & Counting",
    },
    transformations: [
    ...
    footer: {
      ...
      emailLabel: "Email:",
      hoursLabel: "Hours:",
      rights: "Fusion Performance. All rights reserved.",
  ...
  fa: {
    nav: {
      ...
      results: "نتایج",
      contact: "تماس با ما",
      startToday: "همین امروز شروع کن",
      langSwitch: "English",
    },
    hero: {
      badge: "آموزش عملکرد نخبه‌گان",
      headingLine1: "بدنت را",
      ...
      cta1: "شروع کن",
      cta2: "مشاهده برنامه‌ها",
      scroll: "اسکرول",
      stats: [
        { value: "۱۲K+", label: "تحول" },
        { value: "۹۸٪", label: "ماندگاری مشتریان" },
    ...
    services: {
      badge: "برنامه‌های ما",
      headingBefore: "سلاح خود را",
      headingAccent: "انتخاب کن",
      cta: "این برنامه را بگیر",
      items: [
        {
          title: "تمرین قدرتی",
          ...
          stats: [
            ...
            { label: "مدت برنامه", value: "۱۲ هفته" },
          ],
        },
        {
    ...
    coach: {
      badge: "مربی",
      headingBefore: "ساخته‌شده در",
      headingAccent: "بوته آزمون.",
      headingLine2: "اثبات‌شده با نتایج.",
      ...
      credentials: [
        ...
        "پرورش‌اندامکار سابق رقابتی — قهرمان ۳ بار منطقه",
        "بیش از ۱۲,۰۰۰ مشتری تحول‌یافته از سال ۲۰۱۷",
      ],
      name: "مربی مارکوس",
      title: "سرمربی عملکرد",
    },
    ...
    form: {
      ...
      goal: "هدف اصلی",
      goalPlaceholder: "هدف اصلی خود را انتخاب کنید",
      phone: "تلفن (اختیاری)",
      ...
      errorEmail: "لطفاً یک آدرس ایمیل معتبر وارد کنید",
      errorGoal: "لطفاً یک هدف اصلی انتخاب کنید",
    },
    goals: [
      { value: "weight-loss", label: "کاهش وزن" },
      { value: "muscle-gain", label: "افزایش عضله" },
      { value: "athletic-performance", label: "عملکرد ورزشی" },
      { value: "general-fitness", label: "تناسب اندام و سلامتی" },
    ],
    social: {
      badge: "بیش از ۱۲ هزار تحول و همچنان در حال رشد",
    },
    transformations: [
    ...
    footer: {
      ...
      contact: "تماس با ما",
      email: "coach@fusionperformance.com",
      hours: "دوشنبه تا شنبه، ۶ صبح تا ۹ شب",
      emailLabel: "ایمیل:",
      hoursLabel: "ساعت کاری:",
      rights: "فیوژن پرفورمنس. تمام حقوق محفوظ است.",
      privacy: "حریم خصوصی",
      terms: "شرایط خدمات",
      cookies: "سیاست کوکی",
    },
